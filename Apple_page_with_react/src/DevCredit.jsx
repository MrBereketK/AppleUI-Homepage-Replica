...
const GITHUB_REPO = 'https://github.com/MrBereketK/Apple_HomePage-REACT-';
...
export default function DevCredit() {
  ...
  useEffect(() => {
    ...
    console.log(
      '%c🍎 Apple Homepage — Replicated by Bereket K.',
      styles[0]
    );
    console.log(
      '%c→ https://github.com/MrBereketK/Apple_HomePage-REACT-',
      styles[1]
    );
    console.log(
      '%cThis is a front-end study project. Not affiliated with Apple Inc.',
      styles[2]
    );
